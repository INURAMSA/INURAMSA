/ **
* Awalnya oleh Hafizh & MhankBarBar
* Diulang oleh Lindow
** /
const  {
   Koneksi WAC ,
...
fs . existingSync ( './session.json' )  &&  lindow . loadAuthInfo ( './session.json' )
...
lindow . on ( 'message-new' ,  async  ( lin )  =>  {
		coba  {
			...
			const  reply  =  ( teks )  =>  {
				lindow . sendMessage ( dari ,  teks ,  teks ,  { dikutip : lin } )
			}
